...
Justice / *Prawo i Sprawiedliwosc*), `"PSL"` (Polish People's Party /
*Polskie Stronnictwo Ludowe*), `"Left"` (left-wing parties), `"Other"`,
or `"not voted"`.

## Source

Polish Panel Study (POLPAN, <https://www.polpan.org>), Marta Kołczyńska
(<https://martakolczynska.com/>) and her [blog
post](https://martakolczynska.com/post/polpan-voting-alluvial-plots/).
